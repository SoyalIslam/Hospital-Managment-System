        ...
        <div class="row g-4">
            <div class="col-md-4" data-aos="slide-right">
                <div class="feature-card">
                    <h3><i class="fas fa-user-plus me-2"></i>Add Patient</h3>
                    ...
                    <form action="PatientServlet" method="post">
                        ...
                        <button type="submit" class="btn btn-primary w-100"><i class="fas fa-save me-2"></i>Add Patient</button>
                    </form>
                </div>
            </div>
            <div class="col-md-8" data-aos="slide-left">
                <div class="feature-card">
                    <h3><i class="fas fa-users me-2"></i>Patients List</h3>
                                    ...
                                    try {
                                        ...
                                        while (rs.next()) {
                                            out.println("<tr><td>" + rs.getInt("id") + "</td><td>" + rs.getString("name") +
                                                "</td><td>" + rs.getInt("age") + "</td><td>" + rs.getString("gender") +
                                                "</td><td><a href='#' class='btn btn-sm btn-outline-primary'><i class='fas fa-eye'></i> View</a></td></tr>");
                                        }
                                        conn.close();
                                    } catch (Exception e) {
